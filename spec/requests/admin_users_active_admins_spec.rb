...
describe "AdminUsersActiveAdmins" do
  ...
  context "As an administrator" do
    ...
    it "the admin users view renders" do
      ...
      assert current_path == admin_admin_users_path
    end
    ...
    it "he should create a new admin user" do
      ...
      assert_path admin_admin_user_path(AdminUser.last)
    ...
    context "with an existing admin user" do
      before do
        ...
        @admin_user = AdminUser.create(email: 'test@test.com', password: 'password')
        @admin_user.roles = [@admin_role]
        @admin_user.save
        visit admin_admin_users_path
        assert_path admin_admin_users_path
      end
      ...
      it "he should be able to edit the admin user" do
        new_admin = AdminUser.new(email: 'test@test.com', password: 'password')
        new_role = Factory(:manager_role)

        click_edit(@admin_user)
        assert_path edit_admin_admin_user_path(@admin_user.id)
