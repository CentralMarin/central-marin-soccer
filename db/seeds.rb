...
coach_create(name: 'Mike Crivello', email: 'mcrivello@ussportscamps.com',
             ...
             coached_teams: [
                 {year: 2004, gender: 'Boys', team_level: team_level_premier, name: 'Arsenal Blue', teamsnap_team_id: '167259'}
...
coach_create(name: 'Gareth Owen', email: 'gareth.owen@centralmarinsoccer.com',
             bio: "Coming soon...",
             coached_teams: [
                 {year: 2003, gender: 'Girls', team_level: team_level_silver, name: 'Magic White', teamsnap_team_id: '179599'}
             ]
)
...
coach_create(name: 'Kelly Coffey', email: 'kellcoffey@gmail.com',
             ...
             coached_teams: [
                 {year: 2003, gender: 'Boys', team_level: team_level_premier, name: 'Arsenal Blue', teamsnap_team_id: '187473'}
             ]
)
...
coach_create(name: 'Phil Billeci-gard', email: 'ggaarrdd25@hotmail.com',
             ...
             coached_teams: [
                 {year: 2003, gender: 'Boys', team_level: team_level_gold, name: 'Arsenal White', teamsnap_team_id: '70581'}
             ]
)
...
coach_create(name: 'Tom Ryan', email: 'tom_ryan@branson.org',
             ...
             coached_teams: [
                 {year: 2003, gender: 'Boys', team_level: team_level_silver, name: 'Arsenal Red', teamsnap_team_id: '187474'}
             ]
)
...
coach_create(name: 'Jim Lasher', email: 'fury_92@yahoo.com',
             bio: "Coming soon...",
             coached_teams: [
                 {year: 2003, gender: 'Girls', team_level: team_level_gold, name: '', teamsnap_team_id: '179597'},
...
coach_create(name: 'Jon Owen', email: 'jonathanowen1986@gmail.com',
             bio: "Coming soon...",
             coached_teams: [
                 {year: 2003, gender: 'Girls', team_level: team_level_silver, name: 'Magic Black', teamsnap_team_id: '179598'}
             ]
)
...
coach_create(name: 'Adam Dietz', email: 'dietzadam@yahoo.com',
             ...
             coached_teams: [
                 ...
                 {year: 2000, gender: 'Girls', team_level: team_level_silver, name: '', teamsnap_team_id: '169347'},
                 {year: 1999, gender: 'Girls', team_level: team_level_silver, name: '', teamsnap_team_id: '183280'}
             ]
)
